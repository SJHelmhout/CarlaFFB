...
import pygame
import numpy as np
from evdev import ecodes, InputDevice, ff, InputEvent, UInput
...
def main():
    ...
    # Initialise the camera on the drivers view point
    camera_init_trans = carla.Transform(carla.Location(x=-0.06,y=-0.4, z=1.2), carla.Rotation())
