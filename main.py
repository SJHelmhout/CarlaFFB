...
def get_ffb_device():
    for name in evdev.list_devices():
        ...
        if ecodes.EV_FF in dev.capabilities():
            return dev
    raise Exception("No FFB devices found for this setup")


def upload_rumble_effect(dev: InputDevice):
...
if __name__ == '__main__':
    ...
    # Start camera with PyGame callback
    camera.listen(lambda image: RenderObject.pygame_callback(image, renderObject))
    ...
    renderObject = RenderObject.__init__(image_w, image_h)
